...
def line_fit(points_zip):
    points = np.array(points_zip)
    x = points[0:-1][0]  #fixme, will this work for multidimensional?
    y = points[-1]
...
def InteractiveGraph():
    ...
    def update_point(all_points, point, dx, dy, freq):
        ...
        new_points = np.array(all_points)
        ...
        # okay just for 1d x...
        new_points = [tuple(item) for item in new_points]
